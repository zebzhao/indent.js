var indent = (function() {
    ...
    var exports = {
        css: function (code, tabString) {
            return indent(code || '', filterRules('css'), tabString === undefined ? '\t' : tabString);
        },
        js: function (code, tabString) {
            return indent(code || '', filterRules('js'), tabString === undefined ? '\t' : tabString);
        },
        html: function (code, tabString) {
            return indent(code || '', filterRules('html'), tabString === undefined ? '\t' : tabString);
        },
        /**
